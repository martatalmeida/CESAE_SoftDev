...
#ifndef _3_PRIMEIRAAPP_SWIFT_H
#define _3_PRIMEIRAAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="_3_PrimeiraApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14_3_PrimeiraApp11AppDelegate")
...
SWIFT_CLASS("_TtC14_3_PrimeiraApp13SceneDelegate")
...
SWIFT_CLASS("_TtC14_3_PrimeiraApp14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imagemAnimal;
- (IBAction)botaoClicado:(UIButton * _Nonnull)sender;
- (IBAction)botaoFox:(UIButton * _Nonnull)sender;
- (IBAction)botaoLion:(UIButton * _Nonnull)sender;
- (IBAction)botaoMonkey:(UIButton * _Nonnull)sender;
- (IBAction)botaoPig:(UIButton * _Nonnull)sender;
