...
public class FuncionarioView {
    ...
    public static void menuFuncionario() throws IOException {
        ...
        FuncionarioController funcionarioController = new FuncionarioController("src/main/resources/minimercado.csv");
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    funcionarioController.addVenda("src/main/resources/minimercado.csv",tipoProduto,nomeProduto,quantidadeProduto,precoProduto);
                    break;
